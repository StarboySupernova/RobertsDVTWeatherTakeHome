    ...
    var body: some View {
        VStack(spacing: 5) {
            ...
            HStack {
                ...
                .frame(minWidth: 0, maxWidth: .infinity) //To make two equal width columns, use the frame modifier with minWidth set to 0 and maxWidth to infinity. As simple as that!
